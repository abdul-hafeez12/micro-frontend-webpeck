...
export const RemoteComponent = () => {
  return React.createElement('div',  { className: 'flex justify-center items-center p-4 rounded' }, '👋 Hello from Remote Project B');
};

// Wrap the RemoteComponent with the HOC
export const RemoteComponentWithCenteringB = withCentering(RemoteComponent);


export default RemoteComponentWithCenteringB;
